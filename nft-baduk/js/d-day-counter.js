...
const getDDay = () => {
    // D-Day 날짜 지정
    const setDate = new Date("2022-06-24T23:00:00+0900");
    // D-day 날짜의 연,월,일 구하기
    ...
    // title.innerText = `${setDateYear}년 ${setDateMonth}월 ${setDateDay}일까지 ${day}일 ${hours < 10 ? `0${hours}` : hours}시간 ${minutes < 10 ? `0${minutes}` : minutes}분 ${seconds < 10 ? `0${seconds}` : seconds}초 남았습니다.`;
