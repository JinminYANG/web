...
CREATE TABLE `albums` (
  `id` int NOT NULL,
  `at_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `ab_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `date` date NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-08-17 11:50:42
